...
mkdir -p ./libraries/MyST_source_0/
mkdir -p ./libraries/MyST_sink_0/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v" -work sc_fifo_0     -cdslib ./cds_libs/sc_fifo_0.cds.lib    
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/MyST_source.sv"          -work MyST_source_0 -cdslib ./cds_libs/MyST_source_0.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/MyST_sink.sv"            -work MyST_sink_0   -cdslib ./cds_libs/MyST_sink_0.cds.lib  
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/Lab2_1.v"                                                                                       
fi
