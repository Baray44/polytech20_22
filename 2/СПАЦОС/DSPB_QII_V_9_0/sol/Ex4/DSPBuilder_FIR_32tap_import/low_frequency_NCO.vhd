...
END low_frequency_NCO;

ARCHITECTURE SYN OF low_frequency_NCO IS


	COMPONENT low_frequency_NCO_st
	PORT (
		phi_inc_i	: IN STD_LOGIC_VECTOR (15 DOWNTO 0);
		clk	: IN STD_LOGIC;
		reset_n	: IN STD_LOGIC;
...
BEGIN
	...
	low_frequency_NCO_st_inst : low_frequency_NCO_st
	PORT MAP (
		phi_inc_i  =>  phi_inc_i,
		fsin_o  =>  fsin_o,
		clk  =>  clk,
...
-- Retrieval info:  <NETLIST_SECTION active_core="low_frequency_NCO_st" >
...
-- Retrieval info:      <PRIVATE name = "MODULE_NAME" value="low_frequency_NCO_st"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="low_frequency_NCO_st.v"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "RCFC" value="low_frequency_NCO_cos_c.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCVC" value="low_frequency_NCO_cos_c.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCHC" value="low_frequency_NCO_cos_c.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCFF" value="low_frequency_NCO_cos_f.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCVF" value="low_frequency_NCO_cos_f.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCHF" value="low_frequency_NCO_cos_f.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSFC" value="low_frequency_NCO_sin_c.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSVC" value="low_frequency_NCO_sin_c.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSHC" value="low_frequency_NCO_sin_c.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSFF" value="low_frequency_NCO_sin_f.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSVF" value="low_frequency_NCO_sin_f.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSHF" value="low_frequency_NCO_sin_f.hex"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "filename" value="low_frequency_NCO.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- Retrieval info:      <PRIVATE name = "filename" value="low_frequency_NCO_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- =========================================================
-- RELATED_FILES: low_frequency_NCO_st.v, low_frequency_NCO.vhd;
-- IPFS_FILES: low_frequency_NCO.vho;
-- =========================================================
