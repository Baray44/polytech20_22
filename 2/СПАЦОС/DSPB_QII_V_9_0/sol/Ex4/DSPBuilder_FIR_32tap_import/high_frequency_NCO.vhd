...
END high_frequency_NCO;

ARCHITECTURE SYN OF high_frequency_NCO IS


	COMPONENT high_frequency_NCO_st
	PORT (
		phi_inc_i	: IN STD_LOGIC_VECTOR (15 DOWNTO 0);
		clk	: IN STD_LOGIC;
		reset_n	: IN STD_LOGIC;
...
BEGIN
	...
	high_frequency_NCO_st_inst : high_frequency_NCO_st
	PORT MAP (
		phi_inc_i  =>  phi_inc_i,
		fsin_o  =>  fsin_o,
		clk  =>  clk,
...
-- Retrieval info:  <NETLIST_SECTION active_core="high_frequency_NCO_st" >
...
-- Retrieval info:      <PRIVATE name = "FREQ_VALUE" value="30"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "PHI_INC" value="19661"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "MODULE_NAME" value="high_frequency_NCO_st"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="high_frequency_NCO_st.v"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "RCFC" value="high_frequency_NCO_cos_c.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCVC" value="high_frequency_NCO_cos_c.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCHC" value="high_frequency_NCO_cos_c.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCFF" value="high_frequency_NCO_cos_f.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCVF" value="high_frequency_NCO_cos_f.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RCHF" value="high_frequency_NCO_cos_f.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSFC" value="high_frequency_NCO_sin_c.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSVC" value="high_frequency_NCO_sin_c.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSHC" value="high_frequency_NCO_sin_c.hex"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSFF" value="high_frequency_NCO_sin_f.mif"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSVF" value="high_frequency_NCO_sin_f.v"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "RSHF" value="high_frequency_NCO_sin_f.hex"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "NUM_LCELLS" value="202"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "filename" value="high_frequency_NCO.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "qip">
-- Retrieval info:      <PRIVATE name = "copylib" value="1"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- Retrieval info:      <PRIVATE name = "filename" value="high_frequency_NCO_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- =========================================================
-- RELATED_FILES: high_frequency_NCO_st.v, high_frequency_NCO.vhd;
-- IPFS_FILES: high_frequency_NCO.vho;
-- =========================================================
