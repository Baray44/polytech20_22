...
MODEL               = lab4_block
MODULES             = rt_logging.c lab4_block_capi.c lab4_block_data.c lab4_block_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c
MAKEFILE            = lab4_block.mk
MATLAB_ROOT         = D:/Program Files/MATLAB
ALT_MATLAB_ROOT     = D:/Program Files/MATLAB
MATLAB_BIN          = D:/Program Files/MATLAB/bin
ALT_MATLAB_BIN      = D:/Program Files/MATLAB/bin
MASTER_ANCHOR_DIR   = 
START_DIR           = D:/Политех/Бараев/3 семестр/Нестеров/lab4
...
BUILDARGS           = MATLAB_ROOT=%MATLAB_ROOT% ALT_MATLAB_ROOT=%ALT_MATLAB_ROOT% MATLAB_BIN=%MATLAB_BIN% ALT_MATLAB_BIN=%ALT_MATLAB_BIN%  ISPROTECTINGMODEL=NOTPROTECTING RSIM_SOLVER_SELECTION=2 OPTS="-DSLMSG_ALLOW_SYSTEM_ALLOC -DTGTCONN -DON_TARGET_WAIT_FOR_START=0"
...
MODELLIB                  = lab4_blocklib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = lab4_block_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/raccel/lab4_block \
